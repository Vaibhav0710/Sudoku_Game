...
/**
 * Manages the window, and displays a pop up notification when the user
...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    /**
     * In order to draw the various lines that make up the Sudoku grid, we use a
     * starting x and y offset
     * value (remember, x grows positively from left to right, and y grows
    ...
    /**
     * Background of the actual sudoku board, offset from the window by
     * BOARD_PADDING
     * 
     * @param root
     */
    ...
    /**
     * Each time the user makes an input (which can be 0 to delete a number), we
     * update the user
