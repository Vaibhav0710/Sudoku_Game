 ...
 * A: It requires no external libraries, nor do I ever plan to switch to using
 * external libraries.
 */
public class GameLogic {
    ...
    /**
     * Check to see if the incoming state (what the values of each square happen to
     * be) of the game is either Active
     * (i.e. Unsolved) or Complete (i.e. Solved).
     *
     * @param grid A virtual representation of a sudoku puzzle, which may or may not
     *             be solved.
     * @return Either GameState.Active or GameState.Complete, based on analysis of
     *         solvedSudoku.
     *         <p>
     *         Rules:
     ...
     *         - [0, 0] == [3, 4] allowed
     *         - A number may not be repeated within respective
     *         GRID_BOUNDARYxGRID_BOUNDARY regions within the Sudoku Puzzle
     *         - [0, 0] == [1, 2] not allowed
     *         - [0, 0] == [3, 4] allowed
     */
    ...
    /**
     * Checks the if the current complete or incomplete state of the game is still a
     * valid state of a Sudoku game,
    ...
    /**
     * For the purposes of giving specific names to specific things, a "Square" is
     * one of the 3x3 portions of the
     ...
     * 1. Compare every single element in the array to every other element in the
     * array? (hell no)
